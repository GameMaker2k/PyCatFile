...
def PyCatFile(infiles, outfile, verbose=False):
 ...
 for curfname in GetDirList:
  ...
  flinkoutstr = flinknameintsizehexout+flink;
  ...
  if(ftype==1):
   ...
   fpc.close();
  catfileout = bytes(str(str(str(ftype).rjust(2, "0"))+fileheaderintsizehex+"\0"+fnameoutstr+"\0"+fsizeoutstr+"\0"+flinknameoutstr+"\0"+fctimeoutstr+"\0"+fatimeoutstr+"\0"+fmtimeoutstr+"\0"+fmodeoutstr+"\0"+fuidoutstr+"\0"+fgidoutstr+"\0").encode())+fcontents+bytes(str("\0"));
