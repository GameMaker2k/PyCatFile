...
def PackCatFileFromDirList(infiles, outfile, dirlistfromtxt=False, compression="auto", compressionlevel=None, followlink=False, checksumtype="crc32", verbose=False, returnfp=False):
 return PackCatFile(infiles, outfile, dirlistfromtxt, compression, compressionlevel, followlink, checksumtype, verbose, returnfp);
...
def CatFileToArray(infile, seekstart=0, seekend=0, listonly=False, skipchecksum=False, returnfp=False):
 ...
 while(seekstart<seekend):
  ...
  checksumsval = ReadFileHeaderData(catfp, 2);
  catfcs = checksumsval[0].lower();
  catfccs = checksumsval[1].lower();
  hc = 0;
...
def TarFileToArrayIndexAlt(infiles, dirlistfromtxt=False, listonly=False, checksumtype="crc32", verbose=False):
 listcatfiles = TarFileToArrayAlt(infiles, dirlistfromtxt, listonly, checksumtype, verbose);
 print(listcatfiles);
 if(not listcatfiles):
  return False;
 catarray = {'list': listcatfiles, 'filetoid': {}, 'idtofile': {}, 'filetypes': {'directories': {'filetoid': {}, 'idtofile': {}}, 'files': {'filetoid': {}, 'idtofile': {}}, 'links': {'filetoid': {}, 'idtofile': {}}, 'symlinks': {'filetoid': {}, 'idtofile': {}}, 'hardlinks': {'filetoid': {}, 'idtofile': {}}, 'character': {'filetoid': {}, 'idtofile': {}}, 'block': {'filetoid': {}, 'idtofile': {}}, 'fifo': {'filetoid': {}, 'idtofile': {}}, 'devices': {'filetoid': {}, 'idtofile': {}}}};
...
def ZipFileToArrayIndexAlt(infiles, dirlistfromtxt=False, listonly=False, checksumtype="crc32", verbose=False):
 listcatfiles = ZipFileToArrayAlt(infiles, dirlistfromtxt, listonly, checksumtype, verbose);
 print(listcatfiles);
 if(not listcatfiles):
  return False;
 catarray = {'list': listcatfiles, 'filetoid': {}, 'idtofile': {}, 'filetypes': {'directories': {'filetoid': {}, 'idtofile': {}}, 'files': {'filetoid': {}, 'idtofile': {}}, 'links': {'filetoid': {}, 'idtofile': {}}, 'symlinks': {'filetoid': {}, 'idtofile': {}}, 'hardlinks': {'filetoid': {}, 'idtofile': {}}, 'character': {'filetoid': {}, 'idtofile': {}}, 'block': {'filetoid': {}, 'idtofile': {}}, 'fifo': {'filetoid': {}, 'idtofile': {}}, 'devices': {'filetoid': {}, 'idtofile': {}}}};
