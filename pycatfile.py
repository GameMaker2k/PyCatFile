...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 2/25/2024 Ver. 0.1.4 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 1, 4, "RC 1", 1);
__version_date_info__ = (2024, 2, 25, "RC 1", 1);
...
def CatFileToArray(infile, seekstart=0, seekend=0, listonly=False, skipchecksum=False, returnfp=False):
 ...
 catlist = {'fnumfiles': fnumfiles, 'fversion': catversion};
 if(seekend<=0):
  seekend = fnumfiles;
 if(seekstart>0):
  il = 0;
