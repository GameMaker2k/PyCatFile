...
'''
    ...
    $FileInfo: pyshell.py - Last Update: 7/10/2024 Ver. 0.13.12 RC 1 - Author: cooldude2k $
'''

from __future__ import division, absolute_import, print_function;
import sys, os, traceback, code, re, readline, pycatfile;
...
if(len(sys.argv)<2):
 ...
 cmdinput=None;
 print("PyShell "+sys.version+" on "+sys.platform+os.linesep+"Loaded Python module "+pycatfile.__program_name__+" "+pycatfile.__version__+os.linesep);
 while(True):
  try:
