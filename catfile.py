...
argparser = argparse.ArgumentParser(
    description="Manipulate concatenated files.",
...
argparser.add_argument(
    "-i",
    "--input",
    help="Specify the file(s) to concatenate or the concatenated file to extract.",
    required=True)
argparser.add_argument(
    "-o",
    "--output",
...
argparser.add_argument(
    "-F",
    "--format",
    default=__file_format_list__[0],
    help="Specify the format to use.")
argparser.add_argument(
    "-D",
    "--delimiter",
    default=__file_format_list__[5],
    help="Specify the delimiter to use.")
argparser.add_argument(
    "-m",
    "--formatver",
    default=__file_format_list__[6],
    help="Specify the format version.")
