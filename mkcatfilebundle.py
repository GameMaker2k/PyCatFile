...
'''
    ...
    $FileInfo: mkbundle.py - Last Update: 7/10/2024 Ver. 0.13.12 RC 1 - Author: cooldude2k $
'''
...
if (os.path.exists(tempdir + "/pybundle/pycatfile.py")
        and os.path.isfile(tempdir + "/pybundle/pycatfile.py")):
    os.unlink(tempdir + "/pybundle/pycatfile.py")
if (os.path.exists(tempdir + "/pybundle/pycatfile.py")
        and os.path.isdir(tempdir + "/pybundle/pycatfile.py")):
